import 'package:android_d/utlis/formatters/formatter.dart';
...
class UserModel{
  ...
  /// Covert model to JSON stricture for staring data in Firebase.
  ...
  /// Factory method to cretae a UserModel from  a Firebase document snapshot.
